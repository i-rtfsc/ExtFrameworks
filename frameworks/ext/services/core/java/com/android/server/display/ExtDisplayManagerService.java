...
public class ExtDisplayManagerService implements IExtDisplayManagerService {
    private static final String TAG = ExtDisplayManagerService.class.getSimpleName();

    private DisplayManagerService mDms;
    private VariableRefreshRateService mVrr;

    public ExtDisplayManagerService(Object object) {
        this.mDms = (DisplayManagerService) object;
    }
